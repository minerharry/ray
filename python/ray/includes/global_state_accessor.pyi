...
class GlobalStateAccessor:
    ...
    def get_internal_kv(self, namespace:Union[str, bytes], key:Union[str, bytes])->Optional[bytes]: ...
    ...
    def get_all_resource_usage(self)->Optional[bytes]:
    ...
    def get_actor_info(self, actor_id:ActorID)->Optional[bytes]: ...

    def get_worker_table(self)->list[bytes]: ...

    def get_worker_info(self, worker_id:WorkerID)->Optional[bytes]: ...
    ...
    def get_placement_group_info(self, placement_group_id:PlacementGroupID)->Optional[bytes]: ...

    def get_placement_group_by_name(self, placement_group_name:Union[str, bytes], ray_namespace:Union[str, bytes])->Optional[bytes]: ...
